...
*/
$config['composer_autoload'] = ROOTPATH.'src/vendor/autoload.php';
...
|
*/
$config['log_path'] = ROOTPATH.'tmp/logs/';
...
|
*/
$config['cache_path'] = ROOTPATH.'tmp/cache/';
...
switch ($config['sess_driver']) {
  case 'files':
    $config['sess_save_path'] = ROOTPATH.'tmp/session/';
    break;
